...
const Bubble = (props) => {
  ...
  let bubbleClasses = "px-4 py-2 rounded-tl-2xl rounded-tr-2xl w-auto relative";
  let textClasses = "text-base font-semibold";
  let timeClasses = "text-[12px] text-black font-semibold";
          ...
          <Menu name={id.current} ref={menuRef}>
            ...
            <MenuOptions>
              ...
              <MenuItem
                ...
                onSelect={() => starMessage(messageId, chatId, uid)}
              />
              <MenuItem
                text="Reply"
